...
$active_testimonials = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(id) as active_testimonials FROM `testimonials` WHERE `status` = 1"));
$desabled_testimonials = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(id) as desabled_testimonials FROM `testimonials` WHERE `status` = 0"));
        ...
        <div class="card-body px-3 py-4-5">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <h6 class="font-extrabold mb-0"><?= $active_testimonials['active_testimonials']; ?></h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body px-3 py-4-5">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <h6 class="font-extrabold mb-0"><?= $desabled_testimonials['desabled_testimonials']; ?></h6>
            </div>
          </div>
        </div>
      </div>
    </div>
    <!--desabled News Section End-->
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="align-items-center card-header d-flex justify-content-between">
            ...
            <a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/testimonials.php?mode=add">
          ...
          <div class="card-body">
            ...
            $data = MySQLDataPagination("SELECT * FROM `testimonials` ORDER BY `id` DESC");
            if (!$data['content']) {
              ...
              foreach ($data['content'] as $item) {
                ...
                echo '<tr>
                    ...
                    <td class="d-flex justify-content-around"><a data-bs-toggle="modal" data-bs-target="#ajaxModal"
                        data-href="modals/testimonials.php?mode=edit&id=' . $item['id'] . '"><i
                          class="bi bi-pencil-square" title="Edit"></i></a>';
                echo '<a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/testimonials.php?mode=delete&id=' . $item['id'] . '"><i class="bi bi-trash" title="Delete"></i></a>
                    </td>
                  </tr>';
              }
              echo '</tbody>';
