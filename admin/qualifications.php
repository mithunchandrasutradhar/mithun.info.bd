      ...
      <div class="col-12">
        <div class="card">
          <div class="align-items-center card-header d-flex justify-content-between">
            ...
            <a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/qualifications.php?mode=add">
          ...
          <div class="card-body">
            ...
            $data = MySQLDataPagination("SELECT * FROM `qualifications` ORDER BY `id` DESC");
            if (!$data['content']) {
              ...
              foreach ($data['content'] as $item) {
                echo '<tr>
                    ...
                    <td class="d-flex justify-content-around"><a data-bs-toggle="modal" data-bs-target="#ajaxModal"
                        data-href="modals/qualifications.php?mode=edit&id=' . $item['id'] . '"><i
                          class="bi bi-pencil-square" title="Edit"></i></a>';
                echo '<a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/qualifications.php?mode=delete&id=' . $item['id'] . '"><i class="bi bi-trash" title="Delete"></i></a>
                    </td>
                  </tr>';
              }
              echo '</tbody>';
