...
if ($mode == 'edit' || $mode == 'delete') {
  ...
  $item = mysqli_query($con, "SELECT * FROM `company` WHERE id = $id");
  if (mysqli_num_rows($item) < 1) {
    die("Company Information Empty");
  }
...
<form action="./submit/company.php?action=add" method="POST" enctype="multipart/form-data" autocomplete="off">
  <div class="modal-body">
    <label><strong>Title</strong></label>
    <div class="form-group">
      <input type="text" name="title" placeholder="Enter company title" class="form-control" required>
    </div>
    <label><strong>Url</strong></label>
    <div class="form-group">
      <input type="text" name="url" placeholder="Enter url address" class="form-control" required>
    </div>
    ...
    <div class="input-group">
      ...
      <div class="imagearea">
        <span>Drag & Drop your company logo</span>
      </div>
    </div>
  </div>
...
<form action="./submit/company.php?action=edit" method="POST" enctype="multipart/form-data" autocomplete="off">
...
?>
<div class="modal-header">
  <h4 class="modal-title">Delete Company Info</h4>
</div>
<form action="./submit/company.php?action=delete" method="POST" autocomplete="off">
  <input type="hidden" name="id" value="<?= $id ?>">
  <div class="modal-body">
    <label><strong>Are you sure to delete this Company Information!</strong></label>
