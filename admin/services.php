...
$active_services = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(id) as active_services FROM `services` WHERE `status` = 1"));
$disable_services = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(id) as disable_services FROM `services` WHERE `status` = 0"));
        ...
        <div class="card-body px-3 py-4-5">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <h6 class="font-extrabold mb-0"><?= $active_services['active_services']; ?></h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body px-3 py-4-5">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <h6 class="font-extrabold mb-0"><?= $disable_services['disable_services']; ?></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="align-items-center card-header d-flex justify-content-between">
            ...
            <a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/services.php?mode=add">
          ...
          <div class="card-body">
            ...
            $data = MySQLDataPagination("SELECT * FROM `services` ORDER BY `id` DESC");
            if (!$data['content']) {
              ...
              foreach ($data['content'] as $item) {
                echo '<tr>
                    ...
                    <td class="d-flex justify-content-around"><a data-bs-toggle="modal" data-bs-target="#ajaxModal"
                        data-href="modals/services.php?mode=edit&id=' . $item['id'] . '"><i
                          class="bi bi-pencil-square" title="Edit"></i></a>';
                echo '<a data-bs-toggle="modal" data-bs-target="#ajaxModal" data-href="modals/services.php?mode=delete&id=' . $item['id'] . '"><i class="bi bi-trash" title="Delete"></i></a>
                    </td>
                  </tr>';
              }
              echo '</tbody>';
